...
def page_hypothesis_body():
    ...
    st.markdown("""
    This section presents the key hypotheses that guided our analysis and how the data supports (or refutes) them.
    ...
    st.markdown("""
    ✅ **Conclusion:** As the quality rating increases, the median sale price also increases significantly — confirming the hypothesis.
    ...
    st.markdown("""
    ✅ **Conclusion:** There is a strong positive linear trend, indicating larger homes tend to sell for more — supporting the hypothesis.
    """)
